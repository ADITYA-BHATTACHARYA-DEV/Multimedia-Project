  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black text-white py-12 px-4 md:px-12">
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8 }} className="space-y-12 max-w-6xl mx-auto">
        ...
        {/* Main Grid: Description + Right Column */}
        <div className="grid md:grid-cols-3 gap-8 md:gap-12 pt-8">
          ...
          {/* Right Column: Transcript + Chatbot */}
          <div className="flex flex-col gap-6">
            {topic.transcript && (
              <section className="prose prose-invert bg-black/20 backdrop-blur-md border border-white/10 rounded-2xl p-6 max-h-[400px] overflow-y-auto">
                <h2 className="text-2xl font-bold text-blue-400">Transcript</h2>
